<template>
    <div class="flex flew-row gap-8 justify-between w-full">
        <div class="flex w-[30%]">
            <ol
                class="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400 items-center flex flex-col w-full justify-between">
                <li>
                    <span
